...
b.jgrid.jqID(c)+"'></span>")+"</td>");if(a.p.pgbuttons===true){k=["first"+d,"prev"+d,"next"+d,"last"+d];g==="rtl"&&k.reverse();f=f+("<td id='"+k[0]+"' class='ui-pg-button ui-corner-all'>首页</td>");f=f+("<td id='"+k[1]+"' class='ui-pg-button ui-corner-all'>上一页</td>");f=f+(e!==""?"<td class='ui-pg-button ui-state-disabled' style='width:4px;'><span class='ui-separator'></span></td>"+e+"<td class='ui-pg-button ui-state-disabled' style='width:4px;'><span class='ui-separator'></span></td>":
"")+("<td id='"+k[2]+"' class='ui-pg-button ui-corner-all'>下一页</td>");f=f+("<td id='"+k[3]+"' class='ui-pg-button ui-corner-all'>末页</td>")}else e!==""&&(f=f+e);g==="ltr"&&(f=f+i);f=f+"</tr></tbody></table>";a.p.viewrecords===true&&b("td#"+c+"_"+a.p.recordpos,"#"+j).append("<div dir='"+g+"' style='text-align:"+a.p.recordpos+"' class='ui-paging-info'></div>");b("td#"+c+"_"+a.p.pagerpos,"#"+j).append(f);i=b(".ui-jqgrid").css("font-size")||
