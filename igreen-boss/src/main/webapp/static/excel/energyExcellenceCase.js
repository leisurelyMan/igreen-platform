...
jQuery(document).ready(function(){
	//创建jqGrid组件
	jQuery("#list2").jqGrid({
		url : '../energyExcellenceCase/list.do',//组件创建完成之后请求数据的url
		datatype : "json",//请求数据返回的类型。可选json,xml,txt
		rownumbers: true,
		colNames : ['<b>id</b>','<b>公司</b>','<b>类型</b>','<b>标题</b>','<b>来源</b>','<b>发布机构</b>','<b>更新时间</b>','<b>发布</b>' ],//jqGrid的列显示名字
