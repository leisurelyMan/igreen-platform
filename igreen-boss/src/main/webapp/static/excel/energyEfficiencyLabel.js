...
jQuery(document).ready(function(){
	//创建jqGrid组件
	jQuery("#list2").jqGrid({
		url : '../excelEnergyEfficiencyLabel/energyEfficiencyLabelList.do',//组件创建完成之后请求数据的url
		datatype : "json",//请求数据返回的类型。可选json,xml,txt
		rownumbers: true,
		colNames : ['<b>id</b>','<b>公告号</b>','<b>备案单位</b>','<b>公司类型</b>','<b>备注</b>' ],//jqGrid的列显示名字
		colModel : [ //jqGrid每一列的配置信息。包括名字，索引，宽度,对齐方式.....
		 		    {name:'id',index:'id', width:80,sortable:false},
					{name:'noticeNo',index:'noticeNo', width:80,sortable:false},
					{name:'filingCompany',index:'filingCompany', width:200,sortable:false},
