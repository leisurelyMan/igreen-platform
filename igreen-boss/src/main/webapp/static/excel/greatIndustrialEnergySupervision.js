...
jQuery(document).ready(function(){
	//创建jqGrid组件
	jQuery("#list2").jqGrid({
		url : '../greatIndustrialEnergySupervision/list.do',//组件创建完成之后请求数据的url
		datatype : "json",//请求数据返回的类型。可选json,xml,txt
		rownumbers: true,
		colNames : ['<b>id</b>','<b>公司</b>','<b>监察类型</b>','<b>省</b>','<b>标题</b>','<b>来源</b>','<b>发布机构</b>','<b>更新时间</b>','<b>发布</b>' ],//jqGrid的列显示名字
		colModel : [ //jqGrid每一列的配置信息。包括名字，索引，宽度,对齐方式.....
		 		    {name:'id',index:'id', width:80,sortable:false},
					{name:'companyName',index:'companyName', width:120,sortable:false},
					{name:'superviseType',index:'superviseType', width:120,sortable:false},
		...
		caption : "国家重大工业节能专项监察企业名单"//表格的标题名字
	});
