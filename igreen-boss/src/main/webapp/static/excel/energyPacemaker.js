...
jQuery(document).ready(function(){
	//创建jqGrid组件
	jQuery("#list2").jqGrid({
		url : '../energyPacemaker/list.do',//组件创建完成之后请求数据的url
		datatype : "json",//请求数据返回的类型。可选json,xml,txt
		rownumbers: true,
		colNames : ['<b>id</b>','<b>公司</b>','<b>单位能耗</b>','<b>原料</b>','<b>行业</b>','<b>发布日期</b>','<b>备注</b>' ],//jqGrid的列显示名字
		colModel : [ //jqGrid每一列的配置信息。包括名字，索引，宽度,对齐方式.....
		 		    {name:'id',index:'id', width:80,sortable:false},
					{name:'company',index:'company', width:80,sortable:false},
					{name:'energy',index:'energy', width:200,sortable:false},
					{name:'material',index:'material', width:80,sortable:false},
					{name:'domain',index:'domain', width:80,sortable:false},
					{name:'publishBegin',index:'publishBegin', width:80,sortable:false},
