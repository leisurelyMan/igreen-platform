...
INSERT INTO `web_crawler_config` (`id`, `web_name`, `web_domain`, `web_search_url`, `page_url_regular`, `page_type`, `max_page`, `page_req_method`, `page_result`, `replace_regular`, `detail_url_regular`, `detail_title_regular`, `create_time`, `update_time`, `start_page`, `attr_type`, `attr_name`, `detail_content_regular`, `creater`, `updater`) VALUES
	(3, '上海环境', 'ss.sepb.gov.cn', 'http://ss.sepb.gov.cn/search?q=上海微电机研究所&page=${page}&view=', 'http://ss.sepb.gov.cn/search?q=上海微电机研究所&page=${page}&view=', 1, 2, 1, 'div', NULL, 'http://www\\.sepb\\.gov\\.cn/fa/cms/shhj/shhj\\d+/shhj\\d+/\\d+/\\d+/\\d+.htm', '//div[@id=\'ivs_title\']/tidyText()', NULL, '2018-04-18 14:00:10', 0, 'attr', 'total', '//div[@id=\'ivs_content\']/html()', 2, 2),
	(4, '浙江省环境保护厅', 'www.zjepb.gov.cn', 'http://www.zjepb.gov.cn/jrobot/search.do?webid=2&pg=&p=${page}&tpl=&category=&q=浙江&x=47&y=12', 'http://www.zjepb.gov.cn/jrobot/search.do?webid=2&pg=&p=${page}&tpl=&category=&q=浙江&x=47&y=12', 1, 2, 1, 'div', NULL, 'http://www\\.zjepb\\.gov\\.cn/art/\\d+/\\d+/\\d+/art_\\d+_\\d+.html', '//table[@id=\'article\']//td[@class=\'title\']/text()', NULL, '2018-04-18 14:00:50', 1, 'attr', 'data-pagecount', '//table[@id=\'article\']//td[@class=\'bt_content\']/html()', 2, 2),
	(5, '生态环境部', 'www.mep.gov.cn', 'http://websearch.mep.gov.cn/was5/web/search?page=${page}&channelid=233948&searchword=生态环境&keyword=生态环境', 'http://websearch.mep.gov.cn/was5/web/search?page=${page}&channelid=233948&searchword=生态环境&keyword=生态环境', 1, 2, 1, 'a:contains(尾页)', NULL, 'http://nnsa.mep.gov.cn/\\S+/\\S+/\\d{6}/\\S+_\\d+.htm@http://www.mep.gov.cn/\\S+/\\S+/\\S+/\\d{6}/\\S+_\\d+.htm@http://www.mep.gov.cn/\\S+/\\S+/\\d{6}/\\S+_\\d+.shtml@http://nnsa.mep.gov.cn/\\S+/\\S+/\\S+/\\d{6}/\\S+_\\d+.shtml', '//div[@class=\'detail\']//h1/tidyText()#//div[@class=\'wzxq_biaoti2\']//p/tidyText()#//span[@class=\'title\']//b/tidyText()', NULL, '2018-04-19 09:38:00', 1, 'href', 'page=', '//div[@class=\'wz\']/html()#//div[@class=\'TRS_Editor\']/html()#//div[@id=\'ContentRegion\']/html()', 2, 2),
