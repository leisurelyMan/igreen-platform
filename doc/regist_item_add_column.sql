...
ALTER TABLE `web_crawler_config`
	...
	ALTER TABLE `web_crawler_config`
	ADD COLUMN `replace_regular` VARCHAR(100) NULL DEFAULT NULL COMMENT '分页数据替换无用字符正则表达式' AFTER `page_result`;

-- 正在导出表  igreen.web_crawler_config 的数据：~6 rows (大约)
/*!40000 ALTER TABLE `web_crawler_config` DISABLE KEYS */;
INSERT INTO `web_crawler_config` (`id`, `web_name`, `web_domain`, `web_search_url`, `page_url_regular`, `page_type`, `max_page`, `page_req_method`, `page_result`, `replace_regular`, `detail_url_regular`, `detail_title_regular`, `create_time`, `update_time`, `start_page`, `attr_type`, `attr_name`, `detail_content_regular`, `creater`, `updater`) VALUES
	(3, '上海环境', 'ss.sepb.gov.cn', 'http://ss.sepb.gov.cn/search?q=上海微电机研究所&page=${page}&view=', 'http://ss.sepb.gov.cn/search?q=上海微电机研究所&page=${page}&view=', 2, 2, 1, 'div', '', 'http://www\\.sepb\\.gov\\.cn/fa/cms/shhj/shhj\\d+/shhj\\d+/\\d+/\\d+/\\d+.htm', '//div[@id=\'ivs_title\']/tidyText()', NULL, '2018-04-20 12:56:56', 0, 'attr', 'total', '//div[@id=\'ivs_content\']/html()', 2, 2),
	(4, '浙江省环境保护厅', 'www.zjepb.gov.cn', 'http://www.zjepb.gov.cn/jrobot/search.do?webid=2&pg=&p=${page}&tpl=&category=&q=浙江&x=47&y=12', 'http://www.zjepb.gov.cn/jrobot/search.do?webid=2&pg=&p=${page}&tpl=&category=&q=浙江&x=47&y=12', 2, 2, 1, 'div', '', 'http://www\\.zjepb\\.gov\\.cn/art/\\d+/\\d+/\\d+/art_\\d+_\\d+.html', '//table[@id=\'article\']//td[@class=\'title\']/text()', NULL, '2018-04-20 12:57:05', 1, 'attr', 'data-pagecount', '//table[@id=\'article\']//td[@class=\'bt_content\']/html()', 2, 2),
	(5, '生态环境部', 'www.mep.gov.cn', 'http://websearch.mep.gov.cn/was5/web/search?page=${page}&channelid=233948&searchword=生态环境&keyword=生态环境', 'http://websearch.mep.gov.cn/was5/web/search?page=${page}&channelid=233948&searchword=生态环境&keyword=生态环境', 2, 2, 1, 'a:contains(尾页)', '', 'http://nnsa.mep.gov.cn/\\S+/\\S+/\\d{6}/\\S+_\\d+.htm@http://www.mep.gov.cn/\\S+/\\S+/\\S+/\\d{6}/\\S+_\\d+.htm@http://www.mep.gov.cn/\\S+/\\S+/\\d{6}/\\S+_\\d+.shtml@http://nnsa.mep.gov.cn/\\S+/\\S+/\\S+/\\d{6}/\\S+_\\d+.shtml', '//div[@class=\'detail\']//h1/tidyText()#//div[@class=\'wzxq_biaoti2\']//p/tidyText()#//span[@class=\'title\']//b/tidyText()', NULL, '2018-04-20 12:57:19', 1, 'href', 'page=', '//div[@class=\'wz\']/html()#//div[@class=\'TRS_Editor\']/html()#//div[@id=\'ContentRegion\']/html()', 2, 2),
	(6, 'XX重庆市环境保护局', 'www.cepb.gov.cn', 'http://www.cepb.gov.cn/fzlm/znjs/index.shtml?query=重庆市&pageNo=2', 'http://www.cepb.gov.cn/fzlm/znjs/index.shtml?query=重庆市&pageNo=2', 1, 10, 1, 'input[class=\'page-item\'] :last', NULL, 'http://www.cepb.gov.cn/doc/\\d{4}/\\d{2}/\\d{2}/\\S+.shtml', '//div[@class=\'mainCont\']//h1/tidyText()', NULL, '2018-04-20 09:27:17', 1, 'attr', 'data-pageno', '//div[@id=\'Zoom\']/html()', 2, 2),
	(7, '安徽省环境保护厅', 'www.aepb.gov.cn', 'http://www.aepb.gov.cn/pages/Aepb15_InfoSearch.aspx?Stype=0&SearchKey=安徽&MenuID=&page=${page}', 'http://www.aepb.gov.cn/pages/Aepb15_InfoSearch.aspx?Stype=0&SearchKey=安徽&MenuID=&page=${page}', 2, NULL, 1, 'a:contains(尾页)', NULL, 'http://www.aepb.gov.cn/pages/Aepb15_ShowNews.aspx\\?NType=\\d+\\&NewsID=\\d+', '//div[@class=\'stitle\']//h1/tidyText()', NULL, '2018-04-19 13:11:09', 1, 'href', 'page=', '//div[@class=\'scont\']/html()', 2, 2),
	(8, '北京市环境保护局', 'www.bjepb.gov.cn', 'http://www.bjepb.gov.cn/dig/search.action?ty=&w=false&f=&dr=true&p=${page}&sr=score+desc&rp=szns&advtime=&advrange=&fq=&q=北京市环保局', 'http://www.bjepb.gov.cn/dig/search.action?ty=&w=false&f=&dr=true&p=${page}&sr=score+desc&rp=szns&advtime=&advrange=&fq=&q=北京市环保局', 1, 10, 1, 'div[class=\'cen_top\'] h3', '\\S+约|条\\S+', 'http://www.bjepb.gov.cn/\\S+/\\S+/\\S+/\\d+/index.html@http://www.bjepb.gov.cn/\\S+/\\S+/\\S+/\\S+/\\S+/\\d+/index.html@http://www.bjepb.gov.cn/\\S+/\\S+/\\S+/\\S+/\\d+/index.html', '//div[@class=\'h_dl_t\']/tidyText()', NULL, '2018-04-20 11:11:04', 1, 'text', '', '//div[@id=\'h_dl_c\']/html()', 2, 2),
	(9, '绿色和平', 'www.greenpeace.org.cn', 'http://www.greenpeace.org.cn/page/${page}/?s=绿色', 'http://www.greenpeace.org.cn/page/${page}/?s=绿色', 2, NULL, 1, 'div[class=\'nav-links\'] a[class!=\'next\']:last', '', 'http://www.greenpeace.org.cn/[a-z]+[a-z\\-]+[a-z]/', '//div[@class=\'titleGroup\']/h2/tidyText()', NULL, '2018-04-20 14:16:28', 1, 'text', '', '//div[@class=\'descriptiveParagraph \']/html()', 2, 2);
/*!40000 ALTER TABLE `web_crawler_config` ENABLE KEYS */;
