...
<div class="mainBox nav-main">
  <ul>
    <li><a id="${deleId}1" onclick="setTab('${deleId}',1,6)" href="javascript:void(0);" class="on">基本信息</a></li>
    <li><a id="${deleId}2" onclick="setTab('${deleId}',2,6)" href="javascript:void(0);">环境风险</a></li>
    <li><a id="${deleId}3" onclick="setTab('${deleId}',3,6)" href="javascript:void(0);">环境许可</a></li>
    <li><a id="${deleId}4" onclick="setTab('${deleId}',4,6)" href="javascript:void(0);">风险预测</a></li>
...
<div class="mainBox home-main">
  ...
  <div class="home-inner" id="con_${deleId}_2" style="height: 890px; display:none;">
    <div class="data-box">
  ...
  <div class="home-inner" id="con_${deleId}_3" style="height:910px; display:none;">
    <div class="data-box">
  ...
  <div class="home-inner" id="con_${deleId}_4" style="height:910px; display:none;">
    <div class="data-box">
