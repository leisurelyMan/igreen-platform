 ...
 * @创建时间: 2018-05-16
 */
public class ExcelGreatIndustrialEnergySupervision {
    /**
     * id
     */
    private Integer id;
    ...
    /**
     * 监察类型
     * @param superviseType 监察类型
     */
    public void setSuperviseType(String superviseType) {
        this.superviseType = superviseType == null ? null : superviseType.trim();
    }
